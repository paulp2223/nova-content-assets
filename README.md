...
**Why this repo is public:** Notion (and social) can only embed an image from a
publicly reachable URL. These are sanitized content visuals — no secrets, no private code.
